    ...
    <main className="flex min-h-screen flex-col">
      ...
      <section className="bg-gradient-to-br from-blue-500 to-purple-600 min-h-screen relative">
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-4">
                <Link
                  href="/login"
                  className="bg-white text-blue-600 px-6 py-2 rounded-lg font-medium transition-all duration-200 hover:shadow-lg hover:bg-blue-50"
                >
                  Iniciar Sesión
                </Link>
                <Link
                  href="/register"
                  className="bg-blue-500/30 text-white px-6 py-2 rounded-lg border-2 border-white/50 font-medium transition-all duration-200 hover:shadow-lg hover:bg-white/20 backdrop-blur-sm"
                >
                  Registrarse
                </Link>
              </div>
        ...
        <div className="flex flex-col items-center justify-center min-h-screen text-center px-4">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white mb-6 max-w-4xl leading-tight">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Gestión de Tareas</h3>
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Seguimiento</h3>
              <p className="text-gray-600 dark:text-gray-400">
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Objetivos</h3>
              <p className="text-gray-600 dark:text-gray-400">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-600 py-20">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <Link
            href="/register"
            className="bg-white text-blue-600 px-8 py-4 rounded-lg font-bold text-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
          >
      ...
      <footer className="bg-gray-800 dark:bg-gray-950 text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} Focus-U. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    </main>
